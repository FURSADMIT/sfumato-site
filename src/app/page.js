            ...
            <Reveal>
              ...
              <div className="px-6 md:pl-12 md:pr-10">
                ...
                <p className="mt-5 max-w-[560px] text-[16px] leading-[1.54] text-gray">
                  Каждая наша кампания — это поиск глубинной истины вашего бренда или проекта через эстетику. В нашем ДНК возвышенная символика, драматическое напряжение духа и выразительность.
                </p>
              </div>
            </Reveal>
            <Reveal delay={0.12}>
